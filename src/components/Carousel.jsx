...
// 音效資源，請確保這些 mp3 檔案存在於 public 資料夾
const dingSound = new Howl({
  src: ["/ding.mp3"], // 成功點擊音效
});

const wrongSound = new Howl({
  src: ["/wrong.mp3"], // 點錯/扣分音效
});
...
const Carousel = ({ onFinish, difficulty, initialTime, onBackToHome }) => {
  ...
  const handleTargetCircleClick = useCallback(() => {
    ...
    console.log("Is within target angle?", isTargetAngle);

    // 獲取透明圓圈的中心位置，用於浮動文字的起始點
